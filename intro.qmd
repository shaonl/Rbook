...
[![Ross Ihaka (right) and Robert Gentleman (left) - the creatoRs.](rcreators.png){fig-alt="Picture of R creators."}](https://www.stat.auckland.ac.nz/~ihaka/downloads/Otago.pdf)
...
Did you know that writing code to print "Hello World" is a programming tradition? It's often the first thing a student learns to write in a programming language, and comes to us from the 1970s in Bell Laboratories. Learn more [here](https://en.wikipedia.org/wiki/%22Hello,_World!%22_program).
:::
